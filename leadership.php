...
<html lang="en-US">
    ...
    <body class="home page-template page-template-elementor_header_footer page page-id-1125 wp-custom-logo ehf-template-hello-elementor ehf-stylesheet-hello-elementor elementor-default elementor-template-full-width elementor-kit-930 elementor-page elementor-page-1125">
        ...
        <div class="container">
           <h1 class="headi"><span>Meet</span>Our Team</h1>
           <div class="profiles">
             <div class="profile">
             ...
             <div class="profile" style="margin-top:40%; margin-left:-460px; margin-top:800px; position:flex;">
             ...
             <div class="profile" style="margin-top:50%; margin-left:-926px; margin-top:800px; position:flex;">
               <img src="photo/gad.jpg" class="profile-img">

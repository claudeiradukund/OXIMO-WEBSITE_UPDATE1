        ...
        <div class="content">
           ...
           <div class="format">
              <div class="projectdetails">
                <p>The project is anewly propose appartment house in Kicukiro district. It show cases the intimacy in design with aflexible plan,color selection and materialas sembly which also creates an ambience for its occupants.It is situated on astrategics it which offers an obstructed views of the neighbourhood.The project consists of 4 dwelling units among which there are 2 units of 3 bedrooms.</p>
              </div>
              ...
              <div class="images_more">
                <img src="images/house1.1.png" alt="no_image">
                <img src="images/house1.2.png" alt="no_image">
                <img src="images/house1.3.png" alt="no_image">
                <img src="images/house1.4.png" alt="no_image">
                <img src="images/house1.5.png" alt="no_image">
              </div>
              <div class="inputbox">
                <a href="ask_more.php"><input type="Submit" name="" value="Ask More On This Project"></a>
              </div>
           </div>
        </div>
